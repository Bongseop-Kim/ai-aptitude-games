...
const BUG_REPORT_RECIPIENT = "biblecookie@naver.com";
...
export default function IssueScreen() {
    ...
    return (
        ...
        >
            <Stack.Screen options={{ headerTitle: "버그 신고" }} />
            <VStack spacing="spacing24" style={styles.content}>
                <VStack spacing="spacing16">
                    <ThemeInput
                        label="제목"
                        placeholder="버그 제목을 입력해 주세요"
                        value={subject}
                    ...
                    <ThemeInput
                        label="내용"
                        placeholder="버그가 발생한 상황, 재현 방법 등을 적어 주세요"
                        value={body}
