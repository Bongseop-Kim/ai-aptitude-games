...
const promiseQuestionBank: readonly PromiseQuestion[] = [
  ...
  },
  {
    clues: [
      ...
      { who: '소라', icon: 'restaurant', text: '"조용한 북카페에서 샌드위치를 먹었어"' },
    ],
  ...
  },
  {
    clues: [
      ...
      { who: '아라', icon: 'restaurant', text: '"떡볶이랑 튀김을 같이 먹었어"' },
    ],
  ...
  },
  {
    clues: [
      ...
      { who: '지우', icon: 'restaurant', text: '"점심으로 우동을 먹고 바로 만났어"' },
    ],
  ...
  },
  {
    clues: [
      ...
      { who: '유나', icon: 'restaurant', text: '"케이크를 나눠 먹고 선물을 골랐어"' },
    ],
  ...
  },
  {
    clues: [
      ...
      { who: '채원', icon: 'restaurant', text: '"따뜻한 국밥을 먹고 바로 출발했어"' },
    ],
  ...
  },
  {
    clues: [
      ...
      { who: '다인', icon: 'restaurant', text: '"파스타를 먹고 전시를 보러 갔어"' },
    ],
  ...
  },
  {
    clues: [
      ...
      { who: '윤서', icon: 'restaurant', text: '"칼국수를 먹고 장을 봤어"' },
    ],
