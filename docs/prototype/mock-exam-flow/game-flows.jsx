...
Object.assign(window, {
  FlowCanvas,
  // exported for reuse by the mock-exam flow storyboard (mock-flow.jsx)
  Rps_play, Rotate_play, Promise_play, Potion_play, Path_play,
  Numbers_play, Memory_play, Cat_play, Compare_play, PLAY_FRAMES,
});
